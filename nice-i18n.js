(function () {
  ...
  's01-lead': 'Niza cuida con celo sus favoritos, y la mayoría de las categorías que valen la pena ya pertenecen a alguien. El café es la excepción. La ciudad tiene locales respetados, pero ninguna dirección que todos nombren, en una categoría que la gente busca cada día.',
  ...
  's02-lead': 'La operación de invierno y la de verano no son el mismo negocio a distintos volúmenes. De octubre a mayo la carta es fría y ensamblada, lo que significa sin chef y tres personas. De junio a septiembre se abre la cocina, llegan un chef y un commis, y la terraza funciona hasta tarde.',
  's02-p1': 'De octubre a mayo la carta es fría y ensamblada. Sándwiches en buen pan, bollería de una boulangerie que Koukou elige con cuidado, café que Koukou se toma en serio. Nada de eso se cocina, así que nada necesita un chef. Tres personas llevan el local. De junio a septiembre la cocina se enciende, llegan un chef y un commis, los platos se vuelven más ambiciosos y la terraza funciona hasta tarde.',
  ...
  's03-lead': '927.000 € de ingresos al 26% de EBE, frente al 15% de un restaurante en activo del Carré d\'Or de tamaño comparable. Toda la diferencia es la cocina que Koukou no está dotando durante ocho meses del año.',
  ...
  's03-fnote': 'Un restaurante en activo de 120 cubiertas en el Carré d\'Or opera actualmente con un 15% de EBE sobre unos 830.000 € de ingresos. Este modelo queda claramente por encima, y toda la diferencia es la cocina que Koukou no está dotando durante ocho meses del año.',
  ...
  's04-lead': 'Los locales más sólidos de Niza se apoyan en más de un tipo de cliente, y eso es lo que les permite operar en febrero tanto como en agosto. Los visitantes cargan con el verano, las oficinas y la universidad con los días laborables, y quienes viven cerca construyen el hábito.',
  ...
  's05-lead': 'Cuatro preguntas en Niza no tienen respuesta asentada: el mejor café, el mejor desayuno, el mejor sitio para trabajar, el mejor café con hielo. Las cuatro las responde la misma casa, en las mismas horas, con el mismo producto.',
  ...
  's06-lead': 'Lo que a Niza le falta no es una cocina sino una manera de cuidar a la gente. La hospitalidad latinoamericana es más cálida por hábito que la convención del café francés, no la puede copiar el de dos puertas más allá, y no cuesta nada en tiempo de servicio.',
  ...
  's07-h2': 'Arrendarlo primero, poseerlo después',
's07-lead': '40.000 € para empezar a operar, frente a 180.000 € para comprar. Koukou arrienda un negocio existente, lo lleva con su propio nombre durante un año, y lo compra en el año tres con lo que gana.',
  's07-lead-full': 'Francia tiene una estructura hecha exactamente para esto. Bajo la location-gérance se arrienda un fonds de commerce existente y se opera, pagando al propietario una redevance mensual en lugar de comprar el negocio de contado. El propietario conserva el activo, Koukou conserva el comercio, y el coste de entrada baja de ciento ochenta mil euros a unos cuarenta. El contrato dura un año con renovación tácita, lo que significa que la decisión de comprometerse de verdad se toma después de doce meses de operación real y no antes de un solo día.',
  's07-ph1-h3': 'Uno. Asumirlo. 40.000 €.',
  's07-ph1-p': 'Un contrato de location-gérance sobre un local que ya está operando, con una opción de compra escrita desde el principio. Operación completa desde el día uno bajo el propio nombre, estándares y equipo de Koukou. El contrato se deposita en el greffe y se publica en un diario de anuncios legales, y la redevance lleva IVA al veinte por ciento. La opción de compra importa más que la cifra mensual, porque un plazo de un año con renovación tácita es la verdadera debilidad de la estructura y la opción es lo que la cierra.',
  's07-ph1-p2': 'El primer año es la prueba, y es una prueba conducida sobre un negocio real y no sobre una proyección. Si las cifras encajan, Koukou compra. Si no, la exposición es un depósito y algo de capital de trabajo, no ciento ochenta mil euros del fonds de otra persona.',
  's07-ph2-h3': 'Dos. Comprarlo. Lo paga el negocio.',
  's07-ph2-p': 'Dos años asentados producen lo suficiente para ejercer la opción y adquirir el fonds de contado, en efectivo, sin una nueva llamada a los socios. Koukou llega a la misma posición de activo que habría dado una adquisición, aproximadamente un año más tarde, habiendo arriesgado cuarenta mil euros en lugar de ciento ochenta.',
  's07-th-line': 'Partida',
  's07-th-euro': 'Euro',
  's07-th-lean': 'Nota',
  ...
  's08-lead': 'Cinco cosas, ninguna cara, y entre ellas cierran las incógnitas que quedan.',
  's08-s0-h3': 'Encontrar un propietario que quiera salir pero no salir',
  's08-s0-p': 'La location-gérance rara vez se anuncia, porque listarla señala dificultades a la plantilla y a los proveedores. Se mueve a través de agentes. El enfoque no es preguntar qué hay disponible, es explicar que los socios de Koukou tienen restaurantes en el extranjero, que se están instalando en Niza, y que buscan un propietario que quiera conservar su fonds y dejar de gestionarlo. Esa es una propuesta que un agente puede llevar a un cliente concreto que ya tiene.',
  ...
  's07-teaser': 'Un visitante en Niza se queda unas tres noches, lo que significa que puede volver tres o cuatro veces en un solo viaje. Koukou no intenta ganárselo para siempre, Koukou intenta convertirse en su lugar para ese viaje. Hay doce puntos entre buscar en el teléfono la noche anterior y escribir una reseña en el tren de vuelta donde eso se gana o se pierde, y ninguno necesita capital.',
  's07-teaser-link': 'Recorrer las doce etapas',
  's05-risk-h3': 'Lo que Koukou está aceptando',
  's05-risk-p': 'Cinco cosas son genuinamente inciertas y conviene decirlas con claridad. Un propietario no puede conceder location-gérance a menos que haya llevado el fonds al menos dos años él mismo, lo cual descalifica más locales de lo esperado y hay que comprobarlo pronto en cada candidato. El contrato suele durar un año con renovación tácita, así que sin una opción de compra escrita desde el principio Koukou mejora un negocio que otro puede recuperar. El ticket de invierno se modela a quince euros frente a unos nueve en operaciones comparables de carta fría en otros sitios, y un mejor aprovisionamiento tiene que sostener esa diferencia. Contratar a un chef para cuatro meses en la Côte d\'Azur significa fichar las mismas semanas que todos los restaurantes entre Menton y Saint-Tropez. Y a lo largo de los dos primeros años Koukou no retiene activo alguno, que es el precio de la entrada más baja y debe entenderse como un intercambio deliberado y no como un descuido.',
  ...
  'journey-response': 'La respuesta de Koukou',
  'journey-toggle': 'Qué hace Koukou al respecto',
  'read-mode-text': 'Lee la versión corta, o abre el detalle de cualquier sección.',
  'read-all-open': 'Abrir todo',
  'read-all-close': 'Cerrar todo',
  'more-close': 'Cerrar',
  's01-lead-extra': 'Saber cuáles están realmente cerradas es lo primero útil que hay que establecer, porque ahorra mucho esfuerzo perdido después.',
  's01-more': 'Por qué el café y no el resto',
  's02-more': 'Por qué este es todo el plan',
  's03-more': 'Cómo funcionan la nómina y la redevance',
  's04-more': 'Las cifras detrás de cada uno',
  's05-more': 'Cómo se gana cada una',
  's05-p4a': 'El ranking local funciona según lo reciente y lo constante que la gente haya escrito sobre un sitio, y según detalles que se pueden comprobar en lugar de afirmar. Eso lo convierte en una cuestión de llevar bien el negocio más que de promocionarlo con fuerza.',
  's05-p4b': 'Nombrar al tostador y el origen, y ser directo sobre quién hace el café, da a la gente algo concreto que repetir. Un programa deliberado de pedir reseñas en los primeros noventa días, integrado en cómo se lleva la casa más que añadido después, hace la mayor parte del resto. El reconocimiento hace más que cualquiera de los dos, porque alguien a quien se saluda por su nombre y se le entrega lo de siempre escribirá sobre ello, y un desconocido bien atendido normalmente no.',
  's06-more': 'Qué significa cada uno de verdad',
  's06-passage-a': 'Lo que se acumula con el tiempo es el reconocimiento. Saber el pedido de alguien, su nombre y qué le pasó la semana pasada no cuesta nada, no lo puede comprar un competidor y es la razón real por la que una persona viene cuatro veces por semana en lugar de dos al mes.',
  's06-passage-b': 'La dificultad es que suele vivir en la memoria de un barista y se va cuando él se va, así que hay que construirlo en cómo se lleva la casa: cuentas con nombre, una nota del pedido habitual, y un traspaso entre turnos que cubra personas y no solo stock.',
  's07-more': 'La estructura y lo que cuesta',
  's07-ph1-first': 'Un contrato de location-gérance sobre un local que ya está operando, con una opción de compra escrita desde el principio.',
  's07-ph1-rest': 'Operación completa desde el día uno bajo el propio nombre, estándares y equipo de Koukou. El contrato se deposita en el greffe y se publica en un diario de anuncios legales, y la redevance lleva IVA al veinte por ciento. La opción de compra importa más que la cifra mensual, porque un plazo de un año con renovación tácita es la verdadera debilidad de la estructura y la opción es lo que la cierra.',
  's07-ph2-first': 'Dos años asentados producen lo suficiente para ejercer la opción y adquirir el fonds de contado, en efectivo, sin una nueva llamada a los socios.',
  's07-ph2-rest': 'Koukou llega a la misma posición de activo que habría dado una adquisición, aproximadamente un año más tarde, habiendo arriesgado cuarenta mil euros en lugar de ciento ochenta.',
  'footer': 'Grupo Marea, septiembre de 2026. Las cifras son estimaciones de planificación basadas en datos del sector francés y en cuentas comerciales de Niza divulgadas.',
