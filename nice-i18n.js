...
's07-lead': '40.000 € para empezar a operar, frente a 180.000 € para comprar. Arrendamos un negocio existente, lo llevamos con nuestro nombre durante un año, y lo compramos en el año tres con lo que gana.',
  ...
  's07-ph1-p': 'Un contrato de location-gérance sobre un local que ya está operando, con una opción de compra escrita desde el principio. Operación completa desde el día uno bajo nuestro propio nombre, nuestros propios estándares y nuestro propio equipo. El contrato se deposita en el greffe y se publica en un diario de anuncios legales, y la redevance lleva IVA al veinte por ciento. La opción de compra importa más que la cifra mensual, porque un plazo de un año con renovación tácita es la verdadera debilidad de la estructura y la opción es lo que la cierra.',
  's07-ph1-p2': 'El primer año es la prueba, y es una prueba conducida sobre un negocio real y no sobre una proyección. Si las cifras encajan, compramos. Si no, la exposición es un depósito y algo de capital de trabajo, no ciento ochenta mil euros del fonds de otra persona.',
  's07-ph2-h3': 'Dos. Comprarlo. Lo paga el negocio.',
  's07-ph2-p': 'Dos años asentados producen lo suficiente para ejercer la opción y adquirir el fonds de contado, en efectivo, sin una nueva llamada a los socios. Llegamos a la misma posición de activo que habría dado una adquisición, aproximadamente un año más tarde, habiendo arriesgado cuarenta mil euros en lugar de ciento ochenta.',
  's07-th-line': 'Partida',
  's07-th-euro': 'Euro',
  's07-th-lean': 'Nota',
  ...
  's08-s0-p': 'La location-gérance rara vez se anuncia, porque listarla señala dificultades a la plantilla y a los proveedores. Se mueve a través de agentes. El enfoque no es preguntar qué hay disponible, es explicar que tenemos restaurantes en el extranjero, que nos estamos instalando en Niza, y que buscamos un propietario que quiera conservar su fonds y dejar de gestionarlo. Esa es una propuesta que un agente puede llevar a un cliente concreto que ya tiene.',
  ...
  's07-ph1-rest': 'Operación completa desde el día uno bajo nuestro propio nombre, nuestros propios estándares y nuestro propio equipo. El contrato se deposita en el greffe y se publica en un diario de anuncios legales, y la redevance lleva IVA al veinte por ciento. La opción de compra importa más que la cifra mensual, porque un plazo de un año con renovación tácita es la verdadera debilidad de la estructura y la opción es lo que la cierra.',
  ...
  's07-ph2-rest': 'Llegamos a la misma posición de activo que habría dado una adquisición, aproximadamente un año más tarde, habiendo arriesgado cuarenta mil euros en lugar de ciento ochenta.',
  'footer': 'Grupo Marea, septiembre de 2026. Las cifras son estimaciones de planificación basadas en datos del sector francés y en cuentas comerciales de Niza divulgadas.',
