(function () {
  ...
  's05-risk-p': 'Cuatro cosas son genuinamente inciertas y conviene decirlas con claridad. El ticket de invierno se modela a 15 € frente a unos 9 € en operaciones comparables de carta fría en otros sitios, y el aprovisionamiento premium tiene que sostener esa diferencia. Contratar a un chef para cuatro meses en la Côte d\'Azur significa fichar las mismas semanas que todos los restaurantes entre Menton y Saint-Tropez, el mercado laboral más duro de Francia en el peor momento posible. La calidad del desayuno depende en parte de una boulangerie, así que esa relación hay que cerrarla antes de abrir y no después. Y la cocina hay que comprarla y mantenerla aunque solo funcione cuatro meses, así que aquí no hay ahorro de capital, solo de mano de obra.',
  'sum-3': '927.000 € de ingresos al 27% de EBE, claramente por encima de un comparable local probado',
  ...
  's03-winter-p': 'La temporada baja no es un periodo que haya que sobrevivir con el dinero del verano. Sobre 346.500 € de ingresos con tres personas y sin cocina, de octubre a mayo produce unos 95.000 € de contribución por sí sola. Eso es lo que permite permanecer abiertos todo el año mientras buena parte de la ciudad cierra o reduce, y permanecer abiertos es lo que sostiene la posición en la búsqueda.',
